<template>
    <div class="border-b mb-8" :class="twitterBorderColor">
        <div class="flex items-start flex-shrink-0 p-4 px-8 pb-0">
            <div class="flex w-12 items-top pt-2">
                <img
                    :src="props.user?.profileImage || fallBackImage"
                    alt=""
                    class="inline-block w-12 h-12 rounded-full"
                />
            </div>

            <div class="w-full h-[120px] pl-4">
                <textarea
                    v-model="text"
                    :class="twitterBorderColor"
                    class="w-full text-lg !h-full text-gray-900 resize-none outline-none border rounded-xl p-4 placeholder:text-gray-400 bg-transparent dark:text-white focus:border-blue-500"
        ...
        <!-- Icons -->
        <div class="flex px-8 pb-8 pl-[82px]">
